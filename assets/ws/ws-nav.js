...
export const RESEARCH_SECTIONS = [
  ...
  },
  {
    ...
    // out of the sidebar removes the duplicate Editor > Personal > Notes
    // hierarchy while old editor/page URLs still resolve and light Notes.
    match: any(
      under('/workspace/research/notes'),
      under('/workspace/research/editor'),
      under('/workspace/research/calendar'),
      under('/workspace/page'),
    ),
  },
  {
    id: 'res-files',
    ...
    match: any(
      under('/workspace/research/folders'),
      under('/workspace/folder'),
      under('/workspace/research/files'),
      under('/workspace/research/datasets'),
      under('/workspace/research/mindmaps'),
      under('/workspace/shared'),
    ),
  },
  {
    id: 'res-tasks',
