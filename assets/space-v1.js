...
function setHeader(title,subtitle,kicker){var t=document.getElementById('ws-title'),s=document.getElementById('ws-subtitle');if(t)t.textContent=title;if(s)s.textContent=subtitle;}
...
function ensureModal(){
  ...
  modal.innerHTML='<form method="dialog"><div class="ws-dialog__head"><div><p class="ws-kicker">GRAVITAS+</p><h2 data-space-title>Configure</h2></div><button type="button" class="ws-icon-btn" data-space-close aria-label="Close"><svg class="g-wi g-wi--close" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" shape-rendering="geometricPrecision"><g transform="translate(-3.700 -3.704) scale(1.313744)" stroke-width="1.294"><path d="m5.2 5.2 13.6 13.6"/><path d="m18.8 5.2-13.6 13.6"/></g></svg></button></div><div data-space-body></div><div class="ws-dialog__actions"><button type="button" class="ws-quiet-btn" data-space-close>Cancel</button><button type="submit" class="ws-primary-btn">Save</button></div></form>';
