...
function ensureStyles(){
  ...
  s.textContent=[
    '#op-task-detail{width:min(820px,calc(100vw - 32px));height:min(84dvh,780px);max-height:calc(100dvh - 28px);border:1px solid var(--ws-line,var(--ws-text));border-radius:20px;padding:0;overflow:hidden;background:var(--ws-panel-solid);color:inherit;box-shadow:0 28px 90px rgba(0,0,0,.28)}',
    ...
    '.op-task-detail__head{flex:0 0 auto;display:flex;align-items:flex-start;justify-content:space-between;gap:18px;padding:18px 22px 15px;border-bottom:1px solid var(--ws-line-strong);background:var(--ws-panel-solid);z-index:2}',
    ...
    '.op-task-detail__field input,.op-task-detail__field select,.op-task-detail__field textarea{width:100%;box-sizing:border-box;border:1px solid var(--ws-line,var(--ws-text));border-radius:10px;background:rgba(127,127,127,.025);color:inherit;padding:9px 10px;font:inherit;font-size:13px;outline:none;transition:border-color .15s ease,box-shadow .15s ease,background .15s ease}.op-task-detail__field input:focus,.op-task-detail__field select:focus,.op-task-detail__field textarea:focus{border-color:color-mix(in srgb,var(--g-accent) 68%,var(--ws-line-strong));box-shadow:0 0 0 3px color-mix(in srgb,var(--g-accent) 13%,transparent);background:rgba(127,127,127,.04)}',
    ...
    '.op-task-detail__links{display:flex;flex-wrap:wrap;gap:7px}.op-task-detail__link{display:inline-flex;align-items:center;gap:6px;max-width:100%;border:1px solid var(--ws-line-strong);border-radius:9px;background:rgba(127,127,127,.035);color:inherit;text-decoration:none;padding:7px 9px;font-size:11px;line-height:1.2}.op-task-detail__link span{opacity:.56}.op-task-detail__link strong{font-size:11px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:270px}.op-task-detail__link.is-button{cursor:pointer}.op-task-detail__link:hover{background:rgba(127,127,127,.075)}',
    '.op-task-detail__actions{flex:0 0 auto;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:13px 22px;border-top:1px solid var(--ws-line-strong);background:var(--ws-panel-solid);box-shadow:0 -8px 24px rgba(0,0,0,.025);z-index:2}.op-task-detail__actions-right{display:flex;align-items:center;gap:8px}.op-task-detail__delete{border:1px solid rgba(201,91,91,.56);color:var(--ws-danger);background:transparent;border-radius:9px;padding:8px 12px;font-size:12px;cursor:pointer}.op-task-detail__button{border:1px solid var(--ws-line-strong);background:transparent;color:inherit;border-radius:9px;padding:8px 12px;font-size:12px;cursor:pointer}.op-task-detail__save{border:0;background:var(--g-accent);color:var(--g-text-inverse);border-radius:9px;padding:9px 15px;font-size:12px;font-weight:750;cursor:pointer;min-width:112px}',
...
function ensureDialog(){
  ...
  d.innerHTML='<form id="op-task-detail-form">'+
    '<div class="op-task-detail__head"><div class="op-task-detail__head-main"><p class="op-task-detail__eyebrow">TASK</p><h2 id="op-task-detail-title">Task</h2><div id="op-task-detail-summary" class="op-task-detail__summary"></div></div><button type="button" class="ws-icon-btn" data-op-close aria-label="Close"><svg class="g-wi g-wi--close" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" shape-rendering="geometricPrecision"><g transform="translate(-3.700 -3.704) scale(1.313744)" stroke-width="1.294"><path d="m5.2 5.2 13.6 13.6"/><path d="m18.8 5.2-13.6 13.6"/></g></svg></button></div>'+
