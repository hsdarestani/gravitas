...
var sections=[
  ...
  {id:'research',n:'04',title:'Research & Scientific Validation',short:'Research',owner:'Sajjad',icon:'⌕',group:'flow',desc:'Turns an approved idea into evidence-backed material and checks scientific accuracy before production moves forward.',scope:['Research process','Evidence standard','Scientific validation']},
  ...
  {id:'review',n:'08',title:'Review & Quality Control',short:'Review',owner:'Sajjad',icon:'◇',group:'flow',desc:'Checks scientific correctness, clarity and quality, then gives the final content approval before release.',scope:['Scientific review','Editorial quality','Approval logic']},
