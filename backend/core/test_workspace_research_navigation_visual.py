...
class WorkspaceResearchNavigationVisualTests(SimpleTestCase):
    ...
    def test_visual4_cache_chain_reaches_changed_renderers(self):
        ...
        for marker in (
            '/assets/ws/ws-app.js?v=20260924-funding1',
            ...
            '/assets/ws/ws-design-runtime.js?v=20260920-visual4',
        ):
            self.assertIn(marker, html)

        self.assertIn("./ws-research.js?v=20260920-visual4", app)
        self.assertIn("./ws-nav.js?v=20260920-visual4", app)
        self.assertIn("./ws-home.js?v=20260924-funding1", app)
        self.assertIn("./ws-member-lms.js?v=20260920-visual4", five)
        self.assertIn("./ws-member-progress.js?v=20260920-visual4", five)
        self.assertIn("DESIGN_VERSION = '20260920-visual4'", runtime)
